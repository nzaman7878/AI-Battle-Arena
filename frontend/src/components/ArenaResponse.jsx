  ...
  return (
    <div className="flex flex-col gap-8 my-8 px-4 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Solution 1 */}
        <div className={`relative bg-white dark:bg-zinc-900 border ${winner === 1 ? 'border-emerald-500/50 shadow-emerald-500/10' : 'border-zinc-200 dark:border-zinc-800'} rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-sm flex flex-col transition-all hover:shadow-md`}>
          {winner === 1 && (
          ...
          <div className="text-zinc-700 dark:text-zinc-300">
            <ReactMarkdown 
              ...
              components={{
                h1: ({node, ...props}) => <h1 className="text-xl sm:text-2xl font-bold mt-6 mb-4 text-zinc-900 dark:text-white" {...props} />,
                h2: ({node, ...props}) => <h2 className="text-lg sm:text-xl font-bold mt-5 mb-3 text-zinc-900 dark:text-white" {...props} />,
                h3: ({node, ...props}) => <h3 className="text-base sm:text-lg font-bold mt-4 mb-2 text-zinc-900 dark:text-white" {...props} />,
                p: ({node, ...props}) => <p className="text-sm sm:text-base mb-4 leading-relaxed text-zinc-700 dark:text-zinc-300" {...props} />,
                ul: ({node, ...props}) => <ul className="text-sm sm:text-base list-disc pl-5 sm:pl-6 mb-4 text-zinc-700 dark:text-zinc-300 space-y-1" {...props} />,
                ol: ({node, ...props}) => <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6 mb-4 text-zinc-700 dark:text-zinc-300 space-y-1" {...props} />,
                ...
                code: ({node, inline, className, children, ...props}) => {
                  return !inline ? (
                    <div className="rounded-xl overflow-hidden my-4 border border-zinc-200 dark:border-zinc-800 shadow-sm">
                       <pre className="p-3 sm:p-4 bg-zinc-950 overflow-x-auto text-xs sm:text-sm text-zinc-100">
        ...
        {/* Solution 2 */}
        <div className={`relative bg-white dark:bg-zinc-900 border ${winner === 2 ? 'border-violet-500/50 shadow-violet-500/10' : 'border-zinc-200 dark:border-zinc-800'} rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-sm flex flex-col transition-all hover:shadow-md`}>
          {winner === 2 && (
      ...
      {/* Judge Panel */}
      {judge && (
        <div className="mt-4 bg-gradient-to-br from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-sm relative overflow-hidden">
